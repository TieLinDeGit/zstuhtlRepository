...
<body>
	...
	<div id="top" style="height: 50px; background-color: #3C3C3C; width: 100%;">
		<div style="position: absolute; top: 5px; left: 0px; font-size: 30px; font-weight: 400; color: white; font-family: 'times new roman'">CRM &nbsp;<span style="font-size: 12px;">&copy;2021&nbsp;浙江理工</span></div>
	</div>
		...
		<div style="position: absolute; top: 0px; right: 60px;">
			...
			<form action="workbench/index.jsp" class="form-horizontal" role="form">
				<div class="form-group form-group-lg">
					...
					<div class="checkbox"  style="position: relative;top: 30px; left: 10px; color:#FF0000; ">
